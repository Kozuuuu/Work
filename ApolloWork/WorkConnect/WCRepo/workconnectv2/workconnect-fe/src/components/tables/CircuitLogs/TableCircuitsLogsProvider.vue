  ...
  <q-table style="height: 600px" :columns="columns" :rows="props.rows" dense :loading="props.rows.length === 0"
    ...
    <template v-slot:body="props">
      ...
      <q-tr :props="props">
        ...
        <q-td key="recentDATE" :props="props">
          {{ props.row.recentDATE }}
        </q-td>
        <q-td key="RecentPrimaryprovider" :props="props">
          {{ props.row.RecentPrimaryprovider }}
        </q-td>
        <q-td key="RecentBackupProvider" :props="props">
          {{ props.row.RecentBackupProvider }}
        </q-td>
        <q-td key="previousDATE" :props="props">
          {{ props.row.previousDATE }}
        </q-td>
        <q-td key="PreviousPrimaryProvider" :props="props">
          {{ props.row.PreviousPrimaryProvider }}
        </q-td>
        <q-td key="PreviousBackupProvider" :props="props">
          {{ props.row.PreviousBackupProvider }}
        </q-td>
...
const columns = [
  ...
  {
    name: "RecentPrimaryprovider",
    align: "left",
    label: "Recent Primary Provider",
    field: "RecentPrimaryprovider",
    sortable: true,
  },
  {
    name: "RecentBackupProvider",
    align: "left",
    label: "Recent Backup Provider",
    field: "RecentBackupProvider",
    sortable: true,
  },
  {
    name: "previousDATE",
  ...
  {
    name: "previousPrimaryProvider",
    align: "left",
    label: "Previous Primary Provider",
    field: "PreviousPrimaryProvider",
    sortable: true,
  },
  {
    name: "PreviousBackupProvider",
    align: "left",
    label: "Previous Backup Provider",
    field: "PreviousBackupProvider",
    sortable: true,
  },
  // {
  //   name: "providerStatus",
